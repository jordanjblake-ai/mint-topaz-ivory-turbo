...
/**
 * June 2025 book beat, on purpose:
 * 1. Someone writes HYBRYD (wrong).
 * 2. They rub it out.
 * 3. They draw the official Hybrid Vacations wordmark.
 * "Hybryd" is the draft, not a site typo.
 */
function InkOnBook() {
            ...
            <div className="scene-sticky">
              <div className="scene-art">
                <div className="scene-art-live">
                  ...
                  {scene.id === "dawn" ? (
                    /* Drawn autograph. The name is the image, not missing type. */
                    <p className="scene-credit" aria-label="Designed by Jordan Blake">
